...
public class ActivatableInjectableComponent<T> : ReactiveInjectableComponentBase<T>, ICanRender where T : class, INotifyPropertyChanged
{
    private bool _disposedValue;
    private readonly Subject<Unit> _renderedSubject = new();
    private readonly Subject<Unit> _disposedSubject = new();

    public ActivatableInjectableComponent()
    {
